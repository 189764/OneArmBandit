...
public class SerializationLibrary extends AbstractResourcesLibrary {
  ...
  private static final Logger LOGGER = LogManager
    .getLogger( SerializationLibrary.class );
   ...
   */
  @Override
  public void saveObject( Object object, String structure )
  ...
  protected void saveMe( ) {
    try {
      ...
      LOGGER.warn( "file will be created" );
      e.printStackTrace( );
    }
  ...
  /**
   * This method will load directories from disk. It has supress warning because
   * we have to convert object to List
   */
  ...
  protected void loadMe( ) {
    ...
    try {
      ...
      this.directories = (CopyOnWriteArrayList<Directory>) this.xstream
        .fromXML( reader );
    } catch ( FileNotFoundException e ) {
      LOGGER.warn( "folders will be created because first run of program" );
      this.saveMe( );
    }
  }
   ...
   * @param structure - adressing structure - used to equaling it with structure
