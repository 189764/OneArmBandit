...
public class AdminManagementFrame extends JFrame {
  ...
  public AdminManagementFrame( AdminManagementLogic adminManagementLogic ) {
    ...
    JLabel lblPointsToTransfer = new JLabel(
        "Points to transfer from central bank to the bandit:" );
    ...
    btnTransfer.addActionListener( new ActionListener( ) {
      public void actionPerformed( ActionEvent arg0 ) {
        adminManagementLogic
          .sendPointsToBandit( Integer.parseInt( textField.getText( ) ) );
      }
    } );
